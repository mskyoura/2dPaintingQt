...
public:
    ...
    void setE(int _e1, int _e2, double _e3, int _e4, double _e5, int _e6, int _e7, int _e8, int _e9,
    ...
    void getE(int& _e1, int& _e2, double& _e3, int& _e4, double& _e5, int &_e6, int &_e7, int &_e8, int &_e9, QList<QString> &_names);
