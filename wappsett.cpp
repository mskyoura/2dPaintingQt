...
void wAppsett::setE(int _e1, int _e2, double _e3, int _e4, double _e5, int _e6, int _e7, int _e8,
                    int _e9, QList <QString> & _names, QList <QFont> & _fonts, QList <int> & _fontsMaxWidth,
...
void wAppsett::getE(int& _e1, int& _e2, double& _e3, int& _e4, double& _e5, int& _e6, int &_e7, int &_e8, int &_e9, QList <QString> &_names){
    _e1 = E1;
    _e2 = E2;
    _e3 = E3;
    _e4 = E4;
